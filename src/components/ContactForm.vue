<template>
   <form>
      <fieldset class="fieldset">
         ...
         <input type="text" name="firstname" id="firstame" placeholder="First name"  v-model="form.firstName" />

         <input type="text" name="lastname" id="lastname" placeholder="Last name"  v-model="form.lastName" />

         <input type="text" name="adress" id="address" placeholder="Adress"  v-model="form.address" />
         ...
         <select class="select-birthday" name="month" id="birthday">
            <option value="--">--</option>
            <option value="1">01</option>
            <option value="2">02</option>
            <option value="3">03</option>
         ...
         <select class="select-year" name="year" id="birthday">
            <option value="----">----</option>
